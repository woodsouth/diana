...
const std::vector<ObsDialogInfo::Par> pars = {{"pos", ObsDialogInfo::pt_std, -1, 0, "Position", 0, 0},
                                              ...
                                              {"PwaPwa", ObsDialogInfo::pt_std, -1, 0, "period of waves", 0, 50},
                                              {"HwaHwa", ObsDialogInfo::pt_std, -1, 0, "height of waves", 0, 50},
                                              ...
                                              {"Pw1Pw1", ObsDialogInfo::pt_std, -1, 0, "period of swell waves", 0, 50},
                                              {"Hw1Hw1", ObsDialogInfo::pt_std, -1, 0, "height of swell waves", 0, 50},
                                              {"SWH", ObsDialogInfo::pt_std, -1, 2, "significant Wave Height", 0, 50},
                                              ...
                                              {"Name", ObsDialogInfo::pt_std, -1, 0, "WMO number, callsign or ICAO code", 0, 0},
											  {"StationName", ObsDialogInfo::pt_std, -1, 0, "Name of station", 0, 0},
											  {"PIT", ObsDialogInfo::pt_std, -1, 1, "Precipitation intensity converted to mm/h", 0, 0},
